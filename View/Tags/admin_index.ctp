<div class="tags index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), '/admin/tags/view/'.$tag['Tag']['id']); ?>
			<?php echo $this->Html->link(__('Edit'), '/admin/tags/edit/'.$tag['Tag']['id']); ?>
			<?php echo $this->Form->postLink(__('Delete'), '/admin/tags/delete/'.$tag['Tag']['id'], null, __('Are you sure you want to delete # %s?', $tag['Tag']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
